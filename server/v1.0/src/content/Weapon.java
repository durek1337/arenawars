...
public Weapon clone(){
return new Weapon(this.id, this.name, this.dmg, this.speed, this.chargetime, this.rechargetime, this.ammolimit, this.hold).setBulletSize(this.bulletw, this.bulleth).setDistance(this.distance).setGroundSize(this.groundw, this.groundh);
}
